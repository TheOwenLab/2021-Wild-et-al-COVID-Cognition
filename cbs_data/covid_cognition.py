...
class CovidCogQuestionnaire(Questionnaire):
    ...
    @property
    def map_(self):
        """ The questionnaire map is a dict where keys are the names of the 
            question in the dataset (e.g., questionnaire[question_name]). The 
            values are tuples where the 1st element is the original name in the
            raw datafile, the 2nd element is the question type, and the 3rd 
            element (if present) is the order of categories in an ordered
            variable.
        """
        return {
            ...
            'Q2_cough': ('Q2_1', QuestionType.BOOLEAN),
            'Q2_fever': ('Q2_2', QuestionType.BOOLEAN),
            'Q2_difficulty_breathing': ('Q2_3', QuestionType.BOOLEAN),
            'Q2_pneumonia': ('Q2_4', QuestionType.BOOLEAN),
            'Q2_loss_of_smell': ('Q2_5', QuestionType.BOOLEAN),
            'Q2_travel': ('Q2_6', QuestionType.BOOLEAN),
            'Q2_close_contact': ('Q2_7', QuestionType.BOOLEAN),
            'Q2_no_symptoms': ('Q2_8', QuestionType.BOOLEAN),
            ...
            'speak_english': ('Q20_1', QuestionType.BOOLEAN),
            'speak_french': ('Q20_2', QuestionType.BOOLEAN),
            'speak_spanish': ('Q20_3', QuestionType.BOOLEAN),
            ...
            'drugs_none': ('Q30_1', QuestionType.BOOLEAN),
            'drugs_stimulants': ('Q30_2', QuestionType.BOOLEAN),
            'drugs_depressants': ('Q30_3', QuestionType.BOOLEAN),
            'drugs_hallucinogenics': ('Q30_4', QuestionType.BOOLEAN),
            'drugs_other': ('Q30_5', QuestionType.BOOLEAN),
            ...
            'Q34_stroke': ('Q34_4', QuestionType.BOOLEAN),
            'Q34_heart_attack': ('Q34_5', QuestionType.BOOLEAN),
            'Q34_memory_problem': ('Q34_6', QuestionType.BOOLEAN),
            'Q34_concussion': ('Q34_7', QuestionType.BOOLEAN),
            'Q34_none': ('Q34_8', QuestionType.BOOLEAN),
    ...
    def preprocess(self):
        """ This function processes the raw questionnaire data that is 
            downloaded directly from the study server. This is here for 
            visilbility, but is not used for the posted analysis. Instead, the 
            analysis notebooks here start with a semi-processed .CSV file that 
            has stripped of identifying and internal data.
        """
